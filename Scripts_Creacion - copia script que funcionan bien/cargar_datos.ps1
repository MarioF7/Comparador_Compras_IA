...
# VersiÛn: 4.0.0 - Profesional
# ===================================================

# ConfiguraciÛn de codificaciÛn UTF-8 con BOM
...
function Load-DataIntoExcel {
    ...
    try {
        ...
        switch ($Dataset) {
            "Minimo" {
                Write-Log "Cargando dataset mÌnimo..." -Level "INFO"
...
function Load-MinimalDataset {
    ...
    try {
        ...
        @(
            "USR001,Juan PÈrez,juan.perez@email.com,+34 600111222,Calle Mayor 1 1∫A,Madrid,28013,40.416775,-3.703790,5,Coche,NestlÈ;Danone,AlimentaciÛn;Limpieza,Sin lactosa;Sin gluten,450.00,'[{""producto"":""leche"",""fecha"":""2024-01-15""}]',2024-01-15,2024-01-20 10:30:00,TRUE,B·sico",
            "USR002,MarÌa GarcÌa,maria.garcia@email.com,+34 600333444,Avenida Diagonal 100 3∫B,Barcelona,08008,41.385064,2.173403,3,P˙blico,Mercadona;Carrefour,Limpieza;ElectrÛnica,Vegetariano,600.00,'[{""producto"":""detergente"",""fecha"":""2024-01-18""}]',2024-01-18,2024-01-21 15:45:00,TRUE,Avanzado"
        ) | ForEach-Object {
            $row = $_.Split(',')
        ...
        Write-Log "Datos mÌnimos cargados: 2 usuarios, 3 productos, 2 tiendas" -Level "SUCCESS"
        
    } catch {
        Write-Log "Error al cargar dataset mÌnimo: $($_.Exception.Message)" -Level "ERROR"
    }
}
    ...
    try {
        ...
        $users = @(
            @{
                ...
                Pref_Marcas = "NestlÈ,Danone,Kellogg's"
                Pref_Categorias = "AlimentaciÛn,Limpieza"
            ...
            @{
                ...
                Pref_Categorias = "Limpieza,ElectrÛnica,Bebidas"
                Restricciones = "Vegetariano"
                Presupuesto_Mensual = "600.00"
                Historial_Busqueda = '[{"producto":"detergente","fecha":"2024-01-18"},{"producto":"cafÈ","fecha":"2024-01-19"}]'
            ...
            @{
                ...
                Pref_Marcas = "Pascual,Font Vella,CuÈtara"
                Pref_Categorias = "AlimentaciÛn,Bebidas,Dulces"
                Restricciones = "DiabÈtico, Sin az˙car aÒadido"
            ...
            @{
                UserID = "USR004"
                Nombre = "Ana RodrÌguez"
                Email = "ana.rodriguez@email.com"
                Telefono = "+34 600777888"
                Direccion = "Plaza EspaÒa 10, 2∫C"
                Ciudad = "Sevilla"
                CP = "41013"
                Coord_Lat = "37.388630"
                Coord_Lon = "-5.995340"
                ...
                Pref_Marcas = "DÌa,Alcampo,Eroski"
    ...
    try {
        ...
        $products = @(
            @{
                ...
                Categoria = "AlimentaciÛn"
                Subcategoria = "L·cteos"
                Marca = "Pascual"
                Descripcion = "Leche entera UHT tratamiento tÈrmico 1L"
            ...
            @{
                ProductID = "PROD003"
                Nombre = "Detergente LÌquido Ariel"
                Nombre_Cientifico = ""
                Categoria = "Limpieza"
                Subcategoria = "Detergentes"
                Marca = "Ariel"
                Descripcion = "Detergente lÌquido para ropa color 1.5L"
                Caracteristicas = "Elimina manchas difÌciles, protege colores"
                Unidad_Medida = "litro"
            ...
            @{
                ...
                Caracteristicas = "Primera prensada en frÌo, intenso frutado"
                Unidad_Medida = "litro"
                Tamanio_Paquete = "1.000"
                Unidades_Paquete = "1"
                Peso_Bruto = "1100.000"
            ...
            @{
                ProductID = "PROD005"
                Nombre = "CafÈ Molido Natural"
                Nombre_Cientifico = "Coffea arabica"
                Categoria = "AlimentaciÛn"
                Subcategoria = "CafÈs"
                Marca = "Marcilla"
                Descripcion = "CafÈ molido natural 250g"
            ...
            @{
                ...
                Subcategoria = "L·cteos"
                Marca = "Danone"
                Descripcion = "Yogur natural sin az˙car aÒadido 125g"
                Caracteristicas = "ProbiÛticos naturales, sin conservantes"
...
function Generate-CompleteStores {
    ...
    try {
        ...
        $stores = @(
            ...
            @{
                StoreID = "TND002"
                Nombre_Tienda = "Hipercor Gran VÌa"
                Cadena = "Hipercor"
                Direccion = "Gran VÌa 32"
                Ciudad = "Madrid"
                CP = "28013"
                Provincia = "Madrid"
                Pais = "EspaÒa"
                ...
                Tamanio_Tienda = "Grande"
                Servicios = "Delivery,Recogida en tienda,Parking,GuarderÌa"
                Parking = "1"
                Acceso_Discapacitados = "1"
                Wifi_Gratis = "1"
                Cajeros_Automaticos = "1"
            ...
            @{
                StoreID = "TND004"
                Nombre_Tienda = "DÌa Market Toledo"
                Cadena = "DÌa"
    ...
    try {
        ...
        $purchases = @(
            @{
                ...
                Problemas = "Ninguno"
                Sugerencias = "Mejor seÒalizaciÛn en pasillos"
    ...
    try {
        ...
        $preferences = @(
            @{
                ...
                UserID = "USR001"
                Categoria_Favorita = "AlimentaciÛn"
                Subcategoria_Favorita = "L·cteos"
                Marca_Favorita = "NestlÈ"
...
function Generate-TestUsers {
    ...
    try {
        ...
        $firstNames = @("Juan", "MarÌa", "Carlos", "Ana", "Luis", "Laura", "Pedro", "Marta", "Javier", "SofÌa", "David", "Elena", "Miguel", "Isabel", "Pablo")
        $lastNames = @("PÈrez", "GarcÌa", "LÛpez", "RodrÌguez", "MartÌnez", "Fern·ndez", "Gonz·lez", "S·nchez", "Romero", "Torres", "DÌaz", "V·zquez", "Castro", "Ortega", "Navarro")
...
function Generate-TestProducts {
    ...
    try {
        ...
        $productNames = @(
            "Leche", "Arroz", "Aceite", "Az˙car", "Sal", "Harina", "Huevos", "Pan", "Queso", "JamÛn",
            "Yogur", "Fruta", "Verdura", "Carne", "Pescado", "Pasta", "Legumbres", "Cereal", "Galletas", "Chocolate",
            "CafÈ", "TÈ", "Refresco", "Agua", "Zumo", "Vino", "Cerveza", "Detergente", "Suavizante", "LejÌa",
            "JabÛn", "Champ˙", "Gel", "Papel HigiÈnico", "Papel Cocina", "Bolsas Basura", "Film", "Papel Aluminio"
        )
        
        $categories = @{
            "AlimentaciÛn" = @("L·cteos", "Carnes", "Pescados", "Frutas", "Verduras", "PanaderÌa", "Congelados", "Conservas", "Aceites", "Especias")
            "Bebidas" = @("Agua", "Refrescos", "Zumos", "Cervezas", "Vinos", "Licores", "Bebidas EnergÈticas")
            "Limpieza" = @("Detergentes", "Suavizantes", "Limpiadores", "Ambientadores", "Insecticidas", "Papel HigiÈnico")
            "Higiene" = @("Jabones", "Champ˙s", "DentÌfricos", "Desodorantes", "Cuidado Facial", "Cuidado Corporal")
        }
        
        $marcas = @("Marca Blanca", "NestlÈ", "Danone", "Pascual", "Font Vella", "Carrefour", "Mercadona", "DÌa", "Auchan", "Lidl", "Aldi")
        ...
        for ($i = 1; $i -le $Count; $i++) {
            ...
            $rowData = @{
                ...
                Marca = $marca
                Descripcion = "DescripciÛn del producto $productName"
                Caracteristicas = "CaracterÌsticas especiales"
...
function Generate-TestStores {
    ...
    try {
        ...
        $cadenas = @("Mercadona", "Carrefour", "DÌa", "Alcampo", "Lidl", "Aldi", "Eroski", "Consum", "Hipercor", "El Corte InglÈs")
        $cities = @("Madrid", "Barcelona", "Valencia", "Sevilla", "Zaragoza", "M·laga", "Murcia", "Palma", "Las Palmas", "Bilbao")
        ...
        for ($i = 1; $i -le $Count; $i++) {
            ...
            $rowData = @{
                ...
                Tamanio_Tienda = Get-Random @("PequeÒo", "Mediano", "Grande")
...
USR001,Juan PÈ≤•z,juan.perez@email.com,+34 600111222,"Calle Mayor 1, 1¬∫A",Madrid,28013,40.416775,-3.703790,5,Coche,"NestlÈ¨Ñanone","AlimentaciÛÆ¨åimpieza","Sin lactosa, Sin gluten",450.00,'[{"producto":"leche","fecha":"2024-01-15"}]',2024-01-15,2024-01-20 10:30:00,TRUE,B·≥©co
"@
    
    $usuariosCSV | Out-File -FilePath (Join-Path $CSV_DIR "USUARIOS.csv") -Encoding UTF8 -Force
    Write-Log "CSV USUARIOS creado (dataset mÛ∫ë≠o)" -Level "SUCCESS"
}

function Create-CompleteCSVFiles {
    # Nota: En un script real, aquú±• generar´††todos los datos completos como CSV
...
function Create-TestCSVFiles {
    ...
    # Aquú±• implementar®Å¨a generaciÛÆ†≠asiva de datos
...
FECHA DE GENERACI”é: $(Get-Date -Format "dd/MM/yyyy HH:mm:ss")

ARCHIVOS DISPONIBLES:
$(Get-ChildItem $CSV_DIR -Filter "*.csv" | ForEach-Object { "¬ï $($_.Name)" })
...
¬ï -Dataset Minimo    : Dataset mÛ∫ë≠o para pruebas b·≥©cas
¬ï -Dataset Completo  : Dataset completo con datos realistas
¬ï -Dataset Pruebas   : Dataset extenso para pruebas de rendimiento
¬ï -Force             : Sobrescribir datos existentes
¬ï -GenerateOnly      : Solo generar CSV, no cargar en Excel

EJEMPLOS DE USO:
# Cargar dataset mÛ∫ë≠o en Excel
...
function Main {
    ...
    if (-not $Silent) {
        ...
        Write-Host "  VersiÛÆ∫†$VERSION | Dataset: $Dataset" -ForegroundColor Cyan
        Write-Host "===================================================" -ForegroundColor Cyan
        Write-Host "`n"
    }
    ...
    if ($excelAccess) {
        ...
        if ($success) {
            ...
            Write-Log "FallÛ†¨° carga en Excel, creando archivos CSV alternativos..." -Level "WARNING"
            Create-CSVAlternativeDataset
        }
...
try {
    ...
    if (-not $Silent) {
        ...
        Write-Host "¬ï Tiempo total: $($DURATION.ToString('0.00')) segundos" -ForegroundColor White
        Write-Host "¬ï Errores encontrados: $GLOBAL_ERRORS" -ForegroundColor White
        Write-Host "¬ï Dataset: $Dataset" -ForegroundColor White
		
        if (Test-Path $EXCEL_FILE) {
            Write-Host "¬ï Archivo Excel: $EXCEL_FILE" -ForegroundColor White
        }
        
        if (Test-Path $CSV_DIR) {
            $csvCount = (Get-ChildItem $CSV_DIR -Filter "*.csv" | Measure-Object).Count
            Write-Host "¬ï Archivos CSV generados: $csvCount en $CSV_DIR" -ForegroundColor White
        }
        
        Write-Host "¬ï Registro de actividad: $LOG_FILE" -ForegroundColor White
        Write-Host "`n"
